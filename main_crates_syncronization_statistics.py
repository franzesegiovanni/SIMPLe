...
# BiManualTeaching.Panda_right.home_gripper()
    ...
    # %% Test
    # BiManualTeaching.Panda_right.execute_test()
    ...
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()
    # %% EXECUTE DEMONSTRATION AGAIN And eventually GIVE CORRECTIONS
    BiManualTeaching.correction_execute_dual()

    # %%
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()
    # %%  TEST HOW IT PERFORMS IN THE BIMANUAL TASK 1
    BiManualTeaching.execute_dual()
    #%%
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()
    #%%  TEST HOW IT PERFORMS IN THE BIMANUAL TASK 2
    BiManualTeaching.execute_dual()
    #%%
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()

    #%%  TEST HOW IT PERFORMS IN THE BIMANUAL TASK 3 
    BiManualTeaching.execute_dual()
    #%%
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()

    #%%  TEST HOW IT PERFORMS IN THE BIMANUAL TASK 4
    BiManualTeaching.execute_dual()
    #%%
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()

    #%%  TEST HOW IT PERFORMS IN THE BIMANUAL TASK 5
    BiManualTeaching.execute_dual()
    #%%
    BiManualTeaching.Panda_left.home()
    BiManualTeaching.Panda_right.home()