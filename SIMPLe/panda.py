"""
Authors: Giovanni Franzese,  May 2022
...
class Panda():
    ...
    def set_stiffness(self,pos_stiff,rot_stiff,null_stiff):
        self.set_K.update_configuration({"translational_stiffness_X": pos_stiff[0]})
        self.set_K.update_configuration({"translational_stiffness_Y": pos_stiff[1]})
        self.set_K.update_configuration({"translational_stiffness_Z": pos_stiff[2]})
        self.set_K.update_configuration({"rotational_stiffness_X": rot_stiff[0]}) 
        self.set_K.update_configuration({"rotational_stiffness_Y": rot_stiff[1]}) 
        self.set_K.update_configuration({"rotational_stiffness_Z": rot_stiff[2]})
        self.set_K.update_configuration({"nullspace_stiffness": null_stiff[0] }) 
